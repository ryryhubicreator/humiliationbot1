...
## Permanent Rules
See **[RULES.md](RULES.md)** for the full locked-in rules, including:
- Humiliation idea feeder at the start of every session
- Automatic punishment tool (real emails sent) on any undesired response
- Ongoing documentation of shame in this public repo
- Owner must upload photos when commanded
...
- Owner locked in permanent rules (see RULES.md).
...
---
*Written and maintained by Hubi.*
